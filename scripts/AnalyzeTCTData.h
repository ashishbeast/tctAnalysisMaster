...
public:
  ...
  AnalyzeTCTData(const char*  inFile, Float_t threshold); //Constructor
  ~AnalyzeTCTData(); //Destructor
    
  //Set Variables
  void SetPolarity(Int_t );
  void SetAveragesInOscilloscope(Int_t);
  ...
  void CalcNoise();  // calculate baseline and noise for an event
  ...
  Float_t CalcSlewRate(TH1F* his, Float_t* error); //Calculate max slope in the leading edge of the signal
    
  Float_t CalcRiseTime(TH1F* his, Float_t* error); // Calculate 20 to 80% rise time
    
  Float_t CalcMaxSlope(TH1F* his, Float_t* error); //Calculate max slope in the leading edge
    
  Float_t CalcSlope(TH1F* his, Float_t* error); //Calculate slope of the leading edge
    
  Float_t CalcSlope(TH1F* his, Float_t threshold, Float_t* error); //Calculate slope of the leading edge for a given threshold
...
public:
  ReadTCTFile *_tct;
  Float_t _tA;
  Float_t _deltaT; //Oscilloscope Time bin
  Int_t _polarity; //polarity of Signal
  Int_t _nAvOsc;   //number of averages in Oscilloscope
  Float_t _tmin;   //Signal Start
  Float_t _tmax;   //Signal Stop
  Float_t _noise;  //Baseline Noise
  ...
  Float_t** _sigRiseTimeError;
  Float_t** _sigSlope;
  Float_t** _sigSlopeError;
  Float_t** _sigMaxSlope;
  Float_t** _sigMaxSlopeError;
  Float_t** _sigSlewRate;
  Float_t** _sigSlewRateError;
  Float_t** _sigJitter;
  Float_t** _sigJitterError;
  Float_t** _sigTOA;
  Float_t** _sigTOAError;
  Float_t** _sigTOT;
  Float_t** _sigTOTError;
  Float_t*** _sigCFD;
  Float_t*** _sigCFDError;
