...
int main()
{
  ...
  //Wafer 11 Data
  TString filesW11[4]={"../data/slapp_1MIP_W_11_pad_C_type_1_gain_1_VS_IR_a.tct", "../data/slapp_1MIP_W_11_pad_C_type_1_gain_1_VS_IR_a_Noise.tct",
  ...
  for(Int_t k=0;k<4;k+=2)
    {
      cout<<"Processing File: "<<filesW11[k]<<endl;
      info = filesW11[k].Tokenize("_");
      ...
      //slewRate File
      AnalyzeTCTData lgad(filesW11[k]);
      lgad.CorrectBaseline();
      lgad.CalcNoise();
      lgad.CalculateWaveformProperties();
        
      //noise File
      AnalyzeTCTData noise(filesW11[k+1]);
	  ...
	  amp[(i-20)/10] = lgad._sigAmplitude[0][i];
      ...
      else
	{
      ...
      leg11->AddEntry(grJ, legend, "p");
    }

  //Wafer 14 data
  TString filesW14[4]={ "../dataLeo/W_14_Type_2_Area_100_Hole_5_Av_256.tct", "../dataLeo/W_14_Type_2_Area_100_Hole_5.tct",
    "../dataLeo/W_14_Type_3_Area_100_Hole_5_Av_256.tct", "../dataLeo/W_14_Type_3_Area_100_Hole_5.tct"};
   
  for(Int_t k=0;k<4;k+=2)
    {
      cout<<"Processing File: "<<filesW14[k]<<endl;
      info = filesW14[k].Tokenize("_");
	...
	pad = "C";
      ...
      //slewRate File
      AnalyzeTCTData lgad(filesW14[k]);
      lgad.CorrectBaseline();
      lgad.CalcNoise();
      lgad.CalculateWaveformProperties();
        
      //noise File
      AnalyzeTCTData noise(filesW14[k+1]);
      noise.CorrectBaseline();
      noise.CalcNoise();
      noise.CalculateWaveformProperties();
	...
	mStyle = 49;
      ...
      leg14->AddEntry(grJ, legend, "p");
    }
 
  //Wafer 12
  TString filesW12[4]={"../w12Data/w_12_type_2_area_100_av_256", "../w12Data/w_12_type_2_area_100",
    "../w12Data/w_12_type_3_area_100_av_256", "../w12Data/w_12_type_3_area_100"};
  ...
  //Wafer 9
  TString filesW9[4]={"../w9Data/w_9_type_2_area_100_av_256", "../w9Data/w_9_type_2_area_100",
    "../w9Data/w_9_type_3_area_100_av_256", "../w9Data/w_9_type_3_area_100"};
  ...
  //Wafer 1
  TString filesW1[4]={"../w1Data/w_1_type_2_area_100_Hole_3_av_256", "../w1Data/w_1_type_2_area_100_Hole_3",
    "../w1Data/w_1_type_3_area_100_Hole_1_av_256", "../w1Data/w_1_type_3_area_100_Hole_1"};
  ...
  //Wafer 11
  TString gainFilesW11[4]={"../data/slapp_1MIP_W_11_pad_C_type_1_gain_1_VS_IR_a.tct", "../data/slapp_1MIP_W_11_pad_C_type_0_gain_0_VS_IR_a.tct",
  ...
  //Wafer 12
  TString gainFilesW12[4]={"../w12Data/w_12_type_2_area_100_av_256", "../w12Data/w_12_type_2_area_100_NoGain_av_256",
    "../w12Data/w_12_type_3_area_100_av_256", "../w12Data/w_12_type_3_area_100_NoGain_av_256"};
  ...
  //Wafer 9
  TString gainFilesW9[4]={"../w9Data/w_9_type_2_area_100_av_256", "../w9Data/w_9_type_2_area_100_NoGain_av_256",
    "../w9Data/w_9_type_3_area_100_av_256", "../w9Data/w_9_type_3_area_100_NoGain_av_256"};
  ...
  for(Int_t k=0;k<4;k+=2)
    ...
    //Wafer 1
  TString gainFilesW1[4]={"../w1Data/w_1_type_2_area_100_Hole_5_av_256", "../w1Data/w_1_type_3_area_100_NoGain_av_256",
    "../w1Data/w_1_type_3_area_100_Hole_1_av_256", "../w1Data/w_1_type_3_area_100_NoGain_av_256"};
  ...
  for(Int_t k=0;k<4;k+=2)
	...
	pad = "C";
      ...
      cout<<"Processing File: "<<gainFilesW1[k]<<endl;
      //Read LGAD data
      AnalyzeTCTData lgad(gainFilesW1[k]);
      lgad.CorrectBaseline();
      lgad.CalcNoise();
      lgad.CalculateWaveformProperties();
        
      cout<<"Processing File: "<<gainFilesW1[k+1]<<endl;
      //Read PIN data
      AnalyzeTCTData pin(gainFilesW1[k+1], 1.5);
      pin.CorrectBaseline();
      pin.CalcNoise();
      pin.CalculateWaveformProperties();
	...
	gr->SetMarkerStyle(49);
      ...
      can->cd(5);
      gr->Draw("plsame");
      legG1->AddEntry(gr, legend, "p");
    }

  can->SaveAs("../figures/compareSlapWafers.png","png");
  return 0;
}
