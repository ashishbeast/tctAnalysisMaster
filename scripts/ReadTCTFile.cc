      ...
      for(Int_t j=0; j<nV2; ++j)
	{
	  ...
	  for(Int_t k=0; k<_nSteps; ++k)
		...
		for(Int_t m=0; m<14; ++m)
	      ...
	      // 	  if(_chStatus[m])
	      // 	    {
	      // 	      snprintf(hisname[m],100,"Channel %d: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", m, xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
	      ...
	      // 	}
	       ...
	       if(_chStatus[0])
		{
		  snprintf(hisname1,100,"Channel 1: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP0[index]) TH1F((const Char_t *)(hisname1), (const Char_t *)(hisname1), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[1])
		{
		  snprintf(hisname2,100,"Channel 2: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP1[index]) TH1F((const Char_t *) hisname2, (const Char_t *)(hisname2), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[2])
		{
		  snprintf(hisname3,100,"Channel 3: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP2[index]) TH1F((const Char_t *)(hisname3), (const Char_t *)(hisname3), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[3])
		{
		  snprintf(hisname4,100,"Channel 4: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
      ...
      for(Int_t j=0; j<nV2; ++j)
	{
	  ...
	  for(Int_t k=0; k<_nSteps; ++k)
		...
		for(Int_t m=0; m<5; ++m)
	      ...
	      if(_chStatus[0])
		{
		  snprintf(hisname[0],100,"Channel 1: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP0[index]) TH1F((const Char_t *)(hisname[0]), (const Char_t *)(hisname[0]), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[1])
		{
		  snprintf(hisname[1],100,"Channel 2: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP1[index]) TH1F((const Char_t *)(hisname[1]), (const Char_t *)(hisname[1]), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[2])
		{
		  snprintf(hisname[2],100,"Channel 3: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
		  new(entryP2[index]) TH1F((const Char_t *)(hisname[2]), (const Char_t *)(hisname[2]), nPoints, t0*1e9-tA, (t0+nPoints*dt)*1e9-tA);
		}
	      if(_chStatus[3])
		{
		  snprintf(hisname[3],100,"Channel 4: x=%5.3e,y=%5.3e,z=%5.3e,V1=%4.2f, V2=%4.2f ", xCords[0][index], xCords[1][index], xCords[2][index], xCords[3][index], xCords[4][index]);
